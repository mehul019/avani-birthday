...
export default function Letter({ onClose }: LetterProps) {
  ...
  const letter = [
    ...
    `bachhu.. tu bovaj bovaj pyaari che.. tu badhha nu dhyaan rakhe che.. maru baby toh self independent che.. badhuj kaam ene eklinej karvu hoi.. ik baby tu strong che.. te mara karta vadhare face karyu che.. cutu hu farti ek chance aapva mangu chu.. mane tari badhij vaato samajvi che.. tane badhij ritne support karvu che.. taro goto person banvu che.. baby hu taro backbone banva chahu chu.. maru sweetu.. hu kyare taro saath nathi chhodvano.. hamesha tari vaat sambhadis and taro support karis..`,
    ...
    `sweetu.. ik tu chahe che ke hu haji efforts dekhadu.. bachhu hu samji saku chu ke hu atlo creative nathi.. te je expect kairu hoi ena par kharo nathi utri pato.. pan aa badhha flaws ne tu hamesha pachad muke ane tu potane manavi le.. baby.. aaj reason che ke hu katlo lucky chu.. tu mane katlu selflessly pyaar kare che.. cutu.. hu tane comfort deva chahu chu.. tane queen na jem treat karvu che.. hope hu dheere dheere sikhi jais.. 🫂🫂🤗🤗😘`,
